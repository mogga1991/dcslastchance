    ...
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Upload images to Supabase Storage with drag and drop support
        </p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Upload images to Supabase Storage. Maximum file size is 5MB.
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Supabase provides secure, scalable object storage
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-muted-foreground">Row-level security built-in</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <Check className="h-4 w-4 text-green-500 mt-0.5" />
      ...
      {uploadedFiles.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Recently uploaded images to Supabase Storage
            </CardDescription>
          </CardHeader>
          <CardContent>
