...
// Animated Blob Component - Changed to indigo
...
// Gradient Wave Component - Changed to indigo
const GradientWave = () => (
...
// Gradient Background Component - Changed to indigo
...
const SignIn = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log('Calling supabase.auth.signInWithPassword with email:', email.trim());
