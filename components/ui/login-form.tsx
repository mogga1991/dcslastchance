    ...
    <div className="w-full max-w-sm p-8 space-y-6 bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 shadow-2xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="flex items-center justify-between">
          <a href="/forgot-password" className="text-xs text-gray-300 hover:text-white transition">Forgot Password?</a>
        </div>
       ...
       <p className="text-center text-xs text-gray-400">
        Don't have an account? <a href="/sign-up" className="font-semibold text-blue-400 hover:text-blue-300 transition">Sign Up</a>
      </p>
    </div>
  );
}
